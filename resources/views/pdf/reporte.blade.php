...
<body>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="2" class="text-center">
                    <span style="font-size: 25px; font-weight: bold;">Sisema SVLCR</span>
                </td>
            </tr>
            <tr>
                <td width="30%" style="vertical-align: top; padding-top: 10px; position: relative">
                    <img src="{{ asset('assets/img/jp.png') }}" alt="" class="invoice-logo">
                </td>
            ...
            <tbody>
                @foreach($data as $item)
                    <tr>
                        ...
                        <td align="center" >{{\Carbon\Carbon::parse($item->created_at)->format ('00:00:00') , ' d-m-Y'}}</td>
    ...
    <section class="footer">
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            <tr>
                <td width="20%">
                    <span><strong>Sistema SVLCR v1</strong></span>
                </td>
